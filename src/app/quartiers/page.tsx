...
async function getQuartiers(): Promise<Quartier[]> {
  try {
    ...
    const quartiersData = await db.collection('quartiers').find({}).toArray();
            ...
            {quartiers.map((quartier) => (
              ...
              >
                ...
                <div className="space-y-2">
                  <Link
                    href={`/quartiers/${quartier.id}/debouchage-urgent`}
                  ...
                  <Link
                    href={`/quartiers/${quartier.id}/installation-wc`}
                    className="block text-blue-600 hover:text-blue-700"
                  >
                    Installation WC
                  </Link>
                  <Link
                    href={`/quartiers/${quartier.id}/remplacement-chauffe-eau`}
                    className="block text-blue-600 hover:text-blue-700"
                  >
